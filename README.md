# AirBnB_clone
This a AirBnB_clone project done while learning in ALX
...
```bash
git clone https://github.com/kachu1212/AirBnB_clone.git
```
...
<details>
    <summary>Tshiamo BokabaBamidele Adefolaju</summary>
    <ul>
    <li><a href="https://www.github.com/BokabaTia">Github</a></li>
    <li><a href="mailto:Bokabatia@gmail.com">e-mail</a></li>
    </ul>
</details>
